...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MNEC");
    case mBTC: return QString("mMNEC");
    case uBTC: return QString::fromUtf8("μMNEC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MiningEnthusiastCoin");
    case mBTC: return QString("Milli-MiningEnthusiastCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-MiningEnthusiastCoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
