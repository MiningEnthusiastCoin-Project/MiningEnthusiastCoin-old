...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s miningenthusiastcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  miningenthusiastcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded miningenthusiastcoin transaction") + "\n" +
              "  miningenthusiastcoin-tx [options] -create [commands]   " + _("Create hex-encoded miningenthusiastcoin transaction") + "\n" +
              "\n";
